...
import { NotificationListBoxComponent } from '../../../../ynw_consumer/shared/component/notification-list-box/notification-list-box.component';
import { MeetingDetailsComponent } from '../../../../ynw_consumer/components/meeting-details/meeting-details.component';
import { ViewRxComponent } from '../../../../ynw_consumer/components/home/view-rx/view-rx.component';
...
export class HomedashboardComponent implements OnInit, OnDestroy {
 ...
 // this.customId  = this.lStorageService.getitemfromLocalStorage('customId');
 this.accountId = this.lStorageService.getitemfromLocalStorage('accountId');
   console.log("customer Id :",this.customId, this.accountId)


this.getAccountIdFromEncId(this.customId);
  //  this.accountId = this.businessProfile.id;
   // this.customId = this.businessProfile.customId;
  }
  ...
  ngOnInit() {
    ...
    this.getAccountIdFromEncId(this.customId).then(
      (s3UniqueId: any) => {
        this.accountId = s3UniqueId;
        console.log("Unique Id :",this.accountId)
   ...
   */
   getBusinessAccountInfo(uniqueId) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      _this.subs.sink = _this.s3Processor.getJsonsbyTypes(uniqueId,
  ...
  setBusinesssProfile(businessProfile) {
   ...
   // this.customId = businessProfile.customId;
    console.log("businessProfile accountId",this.accountId)
   // console.log("businessProfile customId",this.customId)
  ...
  paymentsClicked() {
   ...
   // this.router.navigate([`${this.customId}`, 'dashboard', 'payments'], navigationExtras);
  ...
  orderpaymentsClicked() {
   ...
   // this.router.navigate([`${this.customId}`, 'dashboard','order','order-payments'], navigationExtras);
  ...
  showcheckindetails(waitlist) {
   ...
   // this.router.navigate([`${this.customId}`, 'dashboard', 'checkindetails'], navigationExtras);
  ...
  showApptdetails(apptlist) {
    ...
    //this.router.navigate([`${this.customId}`, 'dashboard', 'apptdetails'], navigationExtras);
  ...
  showBookingDetails(booking, type?) {
    ...
    if (booking.apptStatus) {
     ...
     // this.router.navigate([`${this.customId}`, 'dashboard', 'orderdetails'], navigationExtras);
...
this.getAppointmentToday();
  ...
  goWaitlistDetail(waitlist) {
   ...
   // this.router.navigate([`${this.customId}/dashboard/waitlist`, waitlist.providerAccount.id, waitlist.ynwUuid]);
  ...
  gotoAptmtReschedule(apptlist) {
   ...
   // this.router.navigate([`${this.customId}`, 'dashboard', 'appointment'], navigationExtras);
  ...
  // this.router.navigate([`${this.customId}`, 'dashboard', 'checkin'], navigationExtras);
...
this.router.navigate(['consumer', 'checkin'], navigationExtras);
  ...
  gotoDonations() {
    ...
    //this.router.navigate([`${this.customId}`, 'dashboard', 'donations']);
  ...
  viewBill(checkin, type, event) {
    ...
    if (type === 'appointment') {
     ...
     //this.router.navigate([`${this.customId}`, 'dashboard', 'appointment', 'bill'], navigationExtras);
      ...
      //this.router.navigate([`${this.customId}`, 'dashboard', 'checkin', 'bill'], navigationExtras);
      ...
      //this.router.navigate([`${this.customId}`, 'dashboard', 'order', 'order-bill'], navigationExtras);
  ...
  makeFailedPayment(waitlist) {
   ...
   // this.router.navigate([`${this.customId}`, 'dashboard', 'checkin', 'payment', waitlist.ynwUuid], navigationExtras);
  ...
  makeApptFailedPayment(waitlist) {
   ...
   // this.router.navigate([`${this.customId}`, 'dashboard', 'appointment', 'payment', waitlist.uid], navigationExtras);
  ...
  gotoHistory() {
   ...
   // this.router.navigate([`${this.customId}`, 'dashboard', 'history'], navigationExtras);
  ...
  gotoApptmentHistory() {
    ...
    //this.router.navigate([`${this.customId}`, 'dashboard', 'appointment', 'history'], navigationExtras);

  }
  gotoOrderHistory() {
    this.router.navigate(['consumer', 'order', 'order-history']);
    //this.router.navigate([`${this.customId}`, 'dashboard', 'order', 'order-history']);
  ...
  gotoLivetrack(uid, accountid, stat) {
    ...
    //this.router.navigate([`${this.customId}`, 'dashboard', 'appointment', 'track', uid], navigationExtras);
  ...
  gotoLivetrackchekin(uid, accountid, stat) {
   ...
   // this.router.navigate([`${this.customId}`, 'dashboard', 'checkin', 'track', uid], navigationExtras);
  ...
  getmyfavourites() {
    ...
    //this.router.navigate([`${this.customId}`, 'dashboard', 'myfav']);
  ...
  gotoQuestionnaire(booking) {
    ...
    //this.router.navigate([`${this.customId}`, 'dashboard', 'questionnaire'], navigationExtras);
