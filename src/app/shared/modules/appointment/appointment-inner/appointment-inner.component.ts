...
@Component({
  selector: 'app-appointment-inner',
  templateUrl: './appointment-inner.component.html'
  })
export class AppointmentInnerComponent implements OnInit {
  servicejson : any = [{
  "id": 659,
  "name": "Consultation",
  "description": "",
