...
@Component({
  selector: 'app-healthcare-bprofile-learnmore',
  templateUrl: './healthcare-bprofile.component.html'
})
export class HealthcareBprofileComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
