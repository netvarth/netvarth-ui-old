...
@Component({
  selector: 'app-automobile-bprofile-learnmore',
  templateUrl: './automobile-bprofile.component.html'
})
export class AutomobileBprofileComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
