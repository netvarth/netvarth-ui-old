...
@Component({
  selector: 'app-personalcare-bprofile-learnmore',
  templateUrl: './personalcare-bprofile.component.html'
})
export class PersonalcareBprofileComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
