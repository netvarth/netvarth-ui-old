...
@Component({
  selector: 'app-foodjoint-bprofile-learnmore',
  templateUrl: './foodjoint-bprofile.component.html'
})
export class FoodjointBprofileComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
