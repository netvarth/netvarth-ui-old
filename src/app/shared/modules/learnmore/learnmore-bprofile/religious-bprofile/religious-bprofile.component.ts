...
@Component({
  selector: 'app-religious-bprofile-learnmore',
  templateUrl: './religious-bprofile.component.html'
})
export class ReligiousBprofileComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
