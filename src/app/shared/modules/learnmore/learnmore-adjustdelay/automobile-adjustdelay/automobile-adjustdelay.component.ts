...
@Component({
  selector: 'app-automobile-adjustdelay-learnmore',
  templateUrl: './automobile-adjustdelay.component.html'
})
export class AutomobileAdjustdelayComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
