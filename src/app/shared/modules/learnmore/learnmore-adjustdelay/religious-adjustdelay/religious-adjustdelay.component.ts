...
@Component({
  selector: 'app-religious-adjustdelay-learnmore',
  templateUrl: './religious-adjustdelay.component.html'
})
export class ReligiousAdjustdelayComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
