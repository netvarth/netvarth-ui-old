...
@Component({
  selector: 'app-personalcare-adjustdelay-learnmore',
  templateUrl: './personalcare-adjustdelay.component.html'
})
export class PersonalcareAdjustdelayComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
