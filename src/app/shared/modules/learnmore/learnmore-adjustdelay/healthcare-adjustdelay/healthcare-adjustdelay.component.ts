...
@Component({
  selector: 'app-healthcare-adjustdelay-learnmore',
  templateUrl: './healthcare-adjustdelay.component.html'
})
export class HealthcareAdjustdelayComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
