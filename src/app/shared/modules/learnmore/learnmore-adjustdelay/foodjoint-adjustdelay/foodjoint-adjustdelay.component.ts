...
@Component({
  selector: 'app-foodjoint-adjustdelay-learnmore',
  templateUrl: './foodjoint-adjustdelay.component.html'
})
export class FoodjointAdjustdelayComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
