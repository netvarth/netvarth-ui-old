...
@Component({
  selector: 'app-personalcare-kiosk-learnmore',
  templateUrl: './personalcare-kiosk.component.html'
})
export class PersonalcareKioskComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
