...
@Component({
  selector: 'app-professional-kiosk-learnmore',
  templateUrl: './professional-kiosk.component.html'
})
export class ProfessionalKioskComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
