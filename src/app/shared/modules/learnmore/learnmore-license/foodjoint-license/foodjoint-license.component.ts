...
@Component({
  selector: 'app-foodjoint-license-learnmore',
  templateUrl: './foodjoint-license.component.html'
})
export class FoodjointLicenseComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
