...
@Component({
  selector: 'app-religious-license-learnmore',
  templateUrl: './religious-license.component.html'
})
export class ReligiousLicenseComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
