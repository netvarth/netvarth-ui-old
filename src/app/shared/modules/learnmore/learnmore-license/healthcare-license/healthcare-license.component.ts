...
@Component({
  selector: 'app-healthcare-license-learnmore',
  templateUrl: './healthcare-license.component.html'
})
export class HealthcareLicenseComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
