...
@Component({
  selector: 'app-automobile-license-learnmore',
  templateUrl: './automobile-license.component.html'
})
export class AutomobileLicenseComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
