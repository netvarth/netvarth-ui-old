...
@Component({
  selector: 'app-personalcare-license-learnmore',
  templateUrl: './personalcare-license.component.html'
})
export class PersonalcareLicenseComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
