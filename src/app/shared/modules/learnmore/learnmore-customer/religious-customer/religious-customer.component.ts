...
@Component({
  selector: 'app-religious-customer-learnmore',
  templateUrl: './religious-customer.component.html'
})
export class ReligiousCustomerComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
