...
@Component({
  selector: 'app-healthcare-customer-learnmore',
  templateUrl: './healthcare-customer.component.html'
})
export class HealthcareCustomerComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
