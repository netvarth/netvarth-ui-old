...
@Component({
  selector: 'app-foodjoint-customer-learnmore',
  templateUrl: './foodjoint-customer.component.html'
})
export class FoodjointCustomerComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
