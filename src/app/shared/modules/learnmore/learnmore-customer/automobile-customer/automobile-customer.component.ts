...
@Component({
  selector: 'app-automobile-customer-learnmore',
  templateUrl: './automobile-customer.component.html'
})
export class AutomobileCustomerComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
