...
@Component({
  selector: 'app-professional-customer-learnmore',
  templateUrl: './professional-customer.component.html'
})
export class ProfessionalCustomerComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
