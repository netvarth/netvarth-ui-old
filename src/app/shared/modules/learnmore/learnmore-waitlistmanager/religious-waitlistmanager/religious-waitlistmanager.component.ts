...
@Component({
  selector: 'app-religious-waitlistmanager-learnmore',
  templateUrl: './religious-waitlistmanager.component.html'
})
export class ReligiousWaitlistmanagerComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
