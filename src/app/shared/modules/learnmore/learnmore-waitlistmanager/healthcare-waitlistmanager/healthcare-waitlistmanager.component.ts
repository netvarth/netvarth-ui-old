...
@Component({
  selector: 'app-healthcare-waitlistmanager-learnmore',
  templateUrl: './healthcare-waitlistmanager.component.html'
})
export class HealthcareWaitlistmanagerComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
