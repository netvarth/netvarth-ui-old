...
@Component({
  selector: 'app-vastu-waitlistmanager-learnmore',
  templateUrl: './vastu-waitlistmanager.component.html'
})
export class VastuWaitlistmanagerComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
