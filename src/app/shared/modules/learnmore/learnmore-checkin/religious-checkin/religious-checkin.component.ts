...
@Component({
  selector: 'app-religious-checkin-learnmore',
  templateUrl: './religious-checkin.component.html'
})
export class ReligiousCheckinComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
