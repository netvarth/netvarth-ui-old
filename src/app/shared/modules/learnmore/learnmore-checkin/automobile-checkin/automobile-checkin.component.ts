...
@Component({
  selector: 'app-automobile-checkin-learnmore',
  templateUrl: './automobile-checkin.component.html'
})
export class AutomobileCheckinComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
