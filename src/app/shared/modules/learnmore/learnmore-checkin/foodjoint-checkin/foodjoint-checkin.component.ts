...
@Component({
  selector: 'app-foodjoint-checkin-learnmore',
  templateUrl: './foodjoint-checkin.component.html'
})
export class FoodjointCheckinComponent implements OnInit, OnDestroy {
  @Input() target: string;
  constructor(
