...
@Component({
  selector: 'app-learnmore-provider-profile',
  templateUrl: './learnmore-provider-profile.component.html'
})
export class LearnmoreProviderProfileComponent implements OnInit {
  @Input() target: string;
  curtype = '';
  constructor(
