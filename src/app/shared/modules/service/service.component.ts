                                ...
                                if (!this.subdomainsettings.serviceBillable) {
                                    if (this.service_data.serviceType === 'donationService') {
                                        this.serviceForm.patchValue({
                                            ...
                                            'leadTime': this.service_data['leadTime'] || this.serviceForm.get('leadTime').value || '0',
        ...
        if (this.subdomainsettings.serviceBillable) {
            if (this.is_donation === true) {
                ...
                this.serviceForm = this.fb.group({
                    ...
                    consumerNoteMandatory: [false],
                    leadTime: [0, Validators.compose([Validators.required, Validators.pattern(this.number_decimal_pattern), Validators.maxLength(10)])],
