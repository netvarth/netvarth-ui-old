export const Messages = {
  ...
  'MORE_SIGNUP': ' Once the trial period ends it automatically switches to Gold package. You can explore various Licence subscription packages under provider settings section. ',
