export const Messages = {
  ...
  'BPROFILE_PRIVACY_PHONE_INVALID': 'Please enter a valid mobile phone number',
   'BPROFILE_COUNTRYCODE': 'Country Code required',
  ...
  'PROVIDER_BILL_PAYMENT_SELFPAY': 'Notification has been sent to the [customer]',
  'PROVIDER_BILL_PAYMENT_link': 'Link has been sent to the [customer]',
  ...
  'SIGN_UP_CAP': 'Sign Up',
  'SIGNUPP_CAP': '"You get Premium - Free Trial for 45 days."',
  'MORE_SIGNUP': ' Once the trial period ends it automatically switches to Premium version. You can explore various Licence subscription packages under provider settings section. ',
  ...
  'FIRST_TIME_COUPON': 'Sign up Coupons',
