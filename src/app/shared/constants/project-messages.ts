export const Messages = {
  ...
  'BPROFILE_SCHOVERLAP': 'The queues schedule overlaps with an existing queue',
  ...
  'PHONE_DIGIT_VAL_MSG': 'Phone number should have 10 digits',
  ...
  //App-ynw_provider-components-add-provider-discounts
