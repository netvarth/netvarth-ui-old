export const projectConstantsLocal = {
  ...
  DATE_FORMAT_WITH_DATE_TIME: 'EEE, MMM d, y hh:mm a',
  BASE_SCHEDULE: [
    {
      day: 4,
      sTime: '09:00 AM',
  ...
  WAITLIST_CANCEL_REASON: [{ title: 'No Show Up', value: 'noshowup', reasonkey: 'noShowUpCancel' },
  { title: 'Self', value: 'self', reasonkey: 'selfCancel' },
  { title: 'Blocked', value: 'blocked', reasonkey: 'blockedCancel' },
  ...
  // { title: 'Queue Disabled', value: 'QueueDisabled', reasonkey: 'tooFullCancel' },
  // { title: 'Holiday', value: 'holiday', reasonkey: 'tooFullCancel' },
  { title: 'Conflict In Schedule', value: 'SCHEDULECONFLICT', reasonkey: 'SCHEDULECONFLICTCancel', type: 2 },
  { title: 'Change of Plans', value: 'CHANGEOFPLAN', reasonkey: 'CHANGEOFPLANCancel', type: 2 },
  { title: 'Illness or Health Issue', value: 'HEALTHISSUE', reasonkey: 'HEALTHISSUECancel', type: 2 },
  { title: 'Other', value: 'other', reasonkey: 'other', type: 2 },
  ],
