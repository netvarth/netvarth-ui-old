...
export class LocalStorageService {
    ...
    dont_delete_localstorage = ['ynw-locdet', 'ynw-createprov', 'supportName', 'supportPass', 'userType', 'version', 'activeSkin', 'qrp', 'qB', 'mUniqueId', 'authToken', 'reqFrom', 'source', 'translatevariable'];
