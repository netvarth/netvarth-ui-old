...
export class LocalStorageService {
    ...
    dont_delete_localstorage = ['ynw-locdet', 'ynw-createprov', 'supportName', 'refreshToken', 'supportPass', 'userType', 'version', 'activeSkin', 'qrp', 'qB', 'mUniqueId', 'authToken', 'reqFrom', 'source', 'translatevariable', 'appId', 'installId', 'order', 'order_sp', 'cleared', 'googleToken'];
