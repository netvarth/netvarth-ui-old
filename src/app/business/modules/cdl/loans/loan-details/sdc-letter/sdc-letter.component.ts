...
@Component({
  selector: 'app-sdc-letter',
  templateUrl: './sdc-letter.component.html',
  styleUrls: ['./sdc-letter.component.css']
})
export class SdcLetterComponent implements OnInit {
  timetype: number = 1;
  from: any;
  type: any;
  user: any;
  ...
  loanData: any;
  constructor(
    public dialogRef: MatDialogRef<SdcLetterComponent>,
