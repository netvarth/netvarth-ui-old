...
@Component({
    selector: 'app-homeservice-queues',
    templateUrl: './homeservice-queues.component.html',
    styleUrls: ['./homeservice-queues.component.css']
})
export class HomeserviceQueuesComponent implements OnInit, OnDestroy {
    loc_name;
