...
@Component({
    selector: 'app-homeservice-queuedetail',
    templateUrl: './homeservice-queuedetails.component.html'
})

export class HomeserviceQueueDetailComponent implements OnInit, OnDestroy {
    ...
    breadcrumbs_init = [
        ...
        },
        {
            ...
            url: '/provider/settings/home-service/queues'
        }
    ];
