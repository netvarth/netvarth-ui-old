...
@Component({
    selector: 'app-homeservice-servicedetail',
    templateUrl: './homeservice-servicedetail.component.html'
})
export class HomeserviceServiceDetailComponent implements OnInit {
    ...
    breadcrumbs_init = [
        ...
        {
            title: 'Services',
            url: '/provider/settings/home-service/services'
        }
    ];
                ...
                if (serviceActionModel) {
                    if (serviceActionModel.service) {
                        ...
                        if (serviceActionModel.action === 'edit') {
                            ...
                            this.router.navigate(['provider/settings/home-service/services']);
                        }
                    }
                }
            }
