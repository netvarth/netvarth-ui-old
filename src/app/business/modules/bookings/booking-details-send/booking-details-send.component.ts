...
@Component({
  selector: 'app-booking-details-send',
  templateUrl: './booking-details-send.component.html'
})
export class BookingDetailsSendComponent implements OnInit {
  uuid: any;
  checkin;
  deptName;
  bname;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<BookingDetailsSendComponent>) {
