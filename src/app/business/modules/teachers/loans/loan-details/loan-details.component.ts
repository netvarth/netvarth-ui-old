...
export class LoanDetailsComponent implements OnInit {
  ...
  showKycDoc() {
    this.router.navigate(['provider', 'tl', 'kycdoc', this.loanId]);
  }


  showLoanDetailsDoc() {
    this.router.navigate(['provider', 'tl', 'loandetailsdoc', this.loanId]);
  }
  ...
  takeAction() {
    ...
    this.router.navigate(['provider', 'tl', 'loans', 'create'], navigationExtras);
  }
