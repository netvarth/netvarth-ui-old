...
@Component({
    selector: 'app-provider-create-checkin',
    templateUrl: './provider-create-checkin.component.html'
})
export class ProviderCreateCheckinComponent implements OnInit {
