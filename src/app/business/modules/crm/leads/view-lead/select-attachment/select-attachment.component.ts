...
fileInfos: Observable<any>;
  ...
  saveFile()
  {
    ...
    return new Promise(function (resolve, reject) {
        ...
        _this.sendWLAttachment(leadid,dataToSend).then(
            () => {
                        resolve(true);
                    }
        )
...
// }
  ...
  sendWLAttachment(leadUid, dataToSend) {
    const _this = this;
    return new Promise(function (resolve, reject) {
        _this.shared_services.addfiletolead(leadUid, dataToSend).subscribe(
            () => {
                resolve(true);
