...
export class ConsumerNotificationsComponent implements OnInit {
  ...
  earlyWLNotificatonSettings = { eventType: 'EARLY', resourceType: 'CHECKIN', sms: false, email: false, telegram: true, whatsApp: true,pushNotification: false, personsAhead: 0 };
  earlyAPPTNotificatonSettings = { eventType: 'EARLY', resourceType: 'APPOINTMENT', sms: false, email: false, telegram: true, whatsApp: true, pushNotification: false, personsAhead: 0 };
  earlyDONATNotificatonSettings = { eventType: 'EARLY', resourceType: 'DONATION', sms: false, email: false, telegram: true, whatsApp: true, pushNotification: false, personsAhead: 0 };
  prefinalWLNotificationSettings = { eventType: 'PREFINAL', resourceType: 'CHECKIN', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false };
  prefinalAPPTNotificationSettings = { eventType: 'PREFINAL', resourceType: 'APPOINTMENT', sms: false, email: false, telegram: true, whatsApp: true, pushNotification: false };
  firstAPPTNotificationSettings = { eventType: 'FIRSTNOTIFICATION', resourceType: 'APPOINTMENT', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false, time: '1440' };
  secondAPPTNotificationSettings = { eventType: 'SECONDNOTIFICATION', resourceType: 'APPOINTMENT', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false, time: '480' };
  thirdAPPTNotificationSettings = { eventType: 'THIRDNOTIFICATION', resourceType: 'APPOINTMENT', sms: false, email: false, telegram: true, whatsApp: true, pushNotification: false, time: '240' };
  fourthAPPTNotificationSettings = { eventType: 'FORTHNOTIFICATION', resourceType: 'APPOINTMENT', sms: false, email: false, telegram: true, whatsApp: true, pushNotification: false, time: '60' };
  prefinalDONATNotificationSettings = { eventType: 'PREFINAL', resourceType: 'DONATION', sms: false, email: false, telegram: true, whatsApp: true, pushNotification: false };
  finalWLNotificationSettings = { eventType: 'FINAL', resourceType: 'CHECKIN', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false };
  finalAPPTNotificationSettings = { eventType: 'FINAL', resourceType: 'APPOINTMENT', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false };
  finalDONATNotificationSettings = { eventType: 'FINAL', resourceType: 'DONATION', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false };
  wlAddNotificationSettings = { eventType: 'WAITLISTADD', resourceType: 'CHECKIN', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false };
  wlCancelNotificationSettings = { eventType: 'WAITLISTCANCEL', resourceType: 'CHECKIN', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false };
  apptAddNotificationSettings = { eventType: 'APPOINTMENTADD', resourceType: 'APPOINTMENT', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false };
  apptCancelNotificationSettings = { eventType: 'APPOINTMENTCANCEL', resourceType: 'APPOINTMENT', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false };
  donatAddNotificationSettings = { eventType: 'DONATIONSERVICE', resourceType: 'DONATION', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false };
  orderAddNotificationSettings = { eventType: 'ORDERCONFIRM', resourceType: 'ORDER', sms: false, email: false, telegram: true, whatsApp: true,pushNotification: false };
  orderCancelNotificationSettings = { eventType: 'ORDERCANCEL', resourceType: 'ORDER', sms: false, email: false, telegram: true, whatsApp: true, pushNotification: false };
  orderStatusChangelNotificationSettings = { eventType: 'ORDERSTATUSCHANGE', resourceType: 'ORDER', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false };
  orderUpdateNotificationSettings={ eventType: 'ORDERUPDATE', resourceType: 'ORDER', sms: false, email: false,telegram: true, whatsApp: true, pushNotification: false };
  showButton: any = {};
  customer_label = '';
