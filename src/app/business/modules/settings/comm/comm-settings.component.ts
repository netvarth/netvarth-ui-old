            ...
            this.provider_services.domainSubdomainSettings(this.domain, this.sub_domain)
                .subscribe(
                    (data: any) => {
                        ...
                        if ((this.sub_domain === 'hospital' || this.sub_domain === 'dentalHosp' || this.sub_domain === 'alternateMedicineHosp' || this.sub_domain === 'hoslisticHealth' ||this.sub_domain === 'veterinaryhospital') && this.accountType === 'BRANCH' && this.isMultilevel) {
