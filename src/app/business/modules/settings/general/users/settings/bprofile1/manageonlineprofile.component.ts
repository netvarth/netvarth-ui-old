...
export class ManageOnlineProfileComponent implements OnInit, OnDestroy {
  breadcrumbs_init = [
    {
  ...
  onlineProfile() {
    this.router.navigate(['provider', 'settings', 'general', 'users', 'manageonlineprofile', 'bprofile']);
  }
  specializations() {
    this.router.navigate(['provider', 'settings', 'general', 'users', 'manageonlineprofile', 'bprofile', 'specializations']);
  }
  additionalInfo() {
    this.router.navigate(['provider', 'settings', 'general', 'users', 'manageonlineprofile', 'bprofile', 'additionalinfo']);
  }
  languagesKnown() {
    this.router.navigate(['provider', 'settings', 'general', 'users', 'manageonlineprofile', 'bprofile', 'languages']);
  }
  galerySocialmedia() {
    this.router.navigate(['provider', 'settings', 'general', 'users', 'manageonlineprofile', 'bprofile', 'media']);
  }
