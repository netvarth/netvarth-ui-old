...
const routes: Routes = [
  { path: '', component: ProviderSettingsComponent },
  {
    ...
    children: [
      ...
      // { path: 'jaldee-integration', loadChildren: () => import('../../../business/modules/settings/bprofile/integration/integration-settings.module').then(m => m.IntegrationSettingsModule) },
