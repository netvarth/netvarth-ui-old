...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'learnmore/healthCare/:parent', component: HealthcareLearnmoreComponent},
      {path: 'learnmore/personalCare/:parent', component: PersonalCareLearnmoreComponent},
      {path: 'learnmore/professionalConsulting/:parent', component: ProfessionalLearnmoreComponent},
      {path: 'learnmore/vastuAstrology/:parent', component: VastuLearnmoreComponent},
      {path: 'learnmore/religiousPriests/:parent', component: ReligiousLearnmoreComponent},
      {path: 'learnmore/foodJoints/:parent', component: FoodjointsLearnmoreComponent},
      {path: 'learnmore/finance/:parent', component: FinanceLearnmoreComponent},
      {path: 'learnmore/veterinaryPetcare/:parent', component: VeterinaryLearnmoreComponent},
